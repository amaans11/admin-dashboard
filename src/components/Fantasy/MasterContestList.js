...
function mapStateToProps(state, ownProps) {
  return {
    getMasterContestsDetailsResponse:
      state.fantasy.getMasterContestsDetailsResponse,
    ...
    createMultipleMatchMultipleMasterContestResponse:
      state.fantasy.createMultipleMatchMultipleMasterContestResponse,
    createMasterContestFromSportToSportResponse:
      state.fantasy.createMasterContestFromSportToSportResponse,
    deleteMasterContestByMasterTypeResponse:
      state.fantasy.deleteMasterContestByMasterTypeResponse
  };
}
