...
class CreateMatch extends React.Component {
  ...
  getAllSeasonPass() {
    this.props.actions.getAllSeasonPass({ sportId: 3 }).then(() => {
      if (
...
function mapStateToProps(state, ownProps) {
  return {
    ...
    matchConfig: state.baseball.matchConfig,
    ...
    getAllCountryCodeResponse: state.baseball.getAllCountryCodeResponse,
    getAllSeasonPassResponse: state.baseball.getAllSeasonPassResponse,
...
function mapDispatchToProps(dispatch) {
  return {
    actions: bindActionCreators(
      { ...baseballActions, ...websiteActions },
      dispatch
    )
  };
}
