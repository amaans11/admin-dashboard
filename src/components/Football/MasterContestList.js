...
function mapStateToProps(state, ownProps) {
  return {
    getMasterContestsDetailsResponse:
      state.football.getMasterContestsDetailsResponse,
    ...
    createMultipleMatchMultipleMasterContestResponse:
      state.football.createMultipleMatchMultipleMasterContestResponse,
    createMasterContestFromSportToSportResponse:
      state.football.createMasterContestFromSportToSportResponse,
    deleteMasterContestByMasterTypeResponse:
      state.football.deleteMasterContestByMasterTypeResponse
  };
}

function mapDispatchToProps(dispatch) {
  return {
    actions: bindActionCreators({ ...footballActions }, dispatch)
  };
}
