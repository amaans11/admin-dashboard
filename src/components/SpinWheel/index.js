...
class SpinWheel extends React.Component {
  ...
  appTypeSelected(appType) {
    ...
    this.props.actions.getSpinWheelConfigs(data).then(() => {
      if (this.props.spinWheelConfig && this.props.spinWheelConfig) {
        let spinWheelData = JSON.parse(this.props.spinWheelConfig);
  ...
  handleSubmit(e) {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        // return;
        this.props.actions.setSpinWheelConfig(data).then(() => {
...
function mapStateToProps(state, ownProps) {
  return {
    spinWheelConfig: state.spinWheel.spinWheelConfig,
...
const SpinWheelForm = Form.create()(SpinWheel);
export default connect(mapStateToProps, mapDispatchToProps)(SpinWheelForm);
