...
class SpecialRewardTable extends React.Component {
  ...
  componentDidMount() {
    ...
    if (
      ...
      this.setState({
        rewardData: this.props.tournament.cloneConfig.specialRewards.rankRanges,
        tableCash: this.props.tournament.cloneConfig.specialRewards.totalCash
          ? this.props.tournament.cloneConfig.specialRewards.totalCash
          : 0,
