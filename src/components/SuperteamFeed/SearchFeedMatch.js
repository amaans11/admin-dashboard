...
class SearchFeedMatch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
  ...
  updateMatchDetail() {
    ...
    this.props.actions.editFootballFeedMatchDetail(matchDetail);
    this.props.history.push('update-match-details');
  }
...
function mapStateToProps(state, ownProps) {
  return {
    ...
    getFeedsFullMatchDetailFeedResponse:
      state.superteamFeed.getFeedsFullMatchDetailFeedResponse
  };
}
...
const SearchFeedMatchForm = Form.create()(SearchFeedMatch);
