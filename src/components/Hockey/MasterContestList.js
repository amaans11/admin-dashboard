...
function mapStateToProps(state, ownProps) {
  return {
    getMasterContestsDetailsResponse:
      state.hockey.getMasterContestsDetailsResponse,
    getAllMasterContestTypeResponse:
      state.hockey.getAllMasterContestTypeResponse,
    matchList: state.hockey.matches,
    createMultipleMatchMultipleMasterContestResponse:
      state.hockey.createMultipleMatchMultipleMasterContestResponse,
    createMasterContestFromSportToSportResponse:
      state.hockey.createMasterContestFromSportToSportResponse,
    deleteMasterContestByMasterTypeResponse:
      state.hockey.deleteMasterContestByMasterTypeResponse
  };
}
