...
function mapStateToProps(state, ownProps) {
  return {
    ...
    allLineFormats: state.hockey.lineFormats,
    contests: state.hockey.contests,
    contestData: state.hockey.contestData,
    getMatchesOrderingResponse: state.hockey.getMatchesOrderingResponse
  };
}
