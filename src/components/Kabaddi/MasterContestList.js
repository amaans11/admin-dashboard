...
function mapStateToProps(state, ownProps) {
  return {
    getMasterContestsDetailsResponse:
      state.kabaddi.getMasterContestsDetailsResponse,
    getAllMasterContestTypeResponse:
      state.kabaddi.getAllMasterContestTypeResponse,
    matchList: state.kabaddi.matches,
    createMultipleMatchMultipleMasterContestResponse:
      state.kabaddi.createMultipleMatchMultipleMasterContestResponse,
    createMasterContestFromSportToSportResponse:
      state.kabaddi.createMasterContestFromSportToSportResponse,
    deleteMasterContestByMasterTypeResponse:
      state.kabaddi.deleteMasterContestByMasterTypeResponse
  };
}
